...
Dim rg As Range
    If blWork Then
        ...
        If Target.Row <> 1 Then
            ...
            Set RgFunction = Nothing
            Set RgFunction2 = Nothing
            Set RgFunctionEx = Nothing
            Set RgFunctionEx2 = Nothing
            Set RgFunctionEx3 = Nothing
            Set RgMeta = Nothing
            ...
            GreyCB UserForm1.cbFunction
            GreyCB UserForm1.cbFunction2
            GreyCB UserForm1.cbFunctionEx
            GreyCB UserForm1.cbFunctionEx2
            GreyCB UserForm1.cbFunctionEx3
            ...
            ElseIf VinCombo(clean(InputSheet.Cells(intARw, intISAction).Value), UserForm1.cbAction) Then
                UserForm1.cbAction.Value = clean(InputSheet.Cells(intARw, intISAction).Value)
            ...
            If VinCombo(ReadValue(intISLibrary), UserForm1.cbLibrary) Then
                ...
                UserForm1.cbFunction.Enabled = True
                UpdateComboBox UserForm1.cbFunction, RgLibrary, intFunction, RgFunction
            ...
            'update Function
            If VinCombo(ReadValue(intISFunction), UserForm1.cbFunction) Then
                UserForm1.cbFunction.Value = ReadValue(intISFunction)
                Set RgFunction = RangeOfValue(UserForm1.cbFunction.Value, intFunction, RgLibrary)
                UpdateComboBox UserForm1.cbFunction2, RgFunction, intFunction2, RgFunction2
            Else
                InvalidCB UserForm1.cbFunction
                GoTo LAST
            End If
            
            'update Function2
            If VinCombo(ReadValue(intISFunction2), UserForm1.cbFunction2) Then
                UserForm1.cbFunction2.Value = ReadValue(intISFunction2)
                Set RgFunction2 = RangeOfValue(UserForm1.cbFunction2.Value, intFunction2, RgFunction)
                UpdateComboBox UserForm1.cbFunctionEx, RgFunction2, intFunctionEx, RgFunctionEx
            Else
                InvalidCB UserForm1.cbFunction2
                GoTo LAST
            End If
            
            'update Function Ex
            If VinCombo(ReadValue(intISFunctionEx), UserForm1.cbFunctionEx) Then
                UserForm1.cbFunctionEx.Value = ReadValue(intISFunctionEx)
                Set RgFunctionEx = RangeOfValue(UserForm1.cbFunctionEx.Value, intFunctionEx, RgFunction2)
                UpdateComboBox UserForm1.cbFunctionEx2, RgFunctionEx, intFunctionEx2, RgFunctionEx2
            Else
                InvalidCB UserForm1.cbFunctionEx
                GoTo LAST
            End If
            
            'update Function Ex2
            If VinCombo(ReadValue(intISFunctionEx2), UserForm1.cbFunctionEx2) Then
                UserForm1.cbFunctionEx2.Value = ReadValue(intISFunctionEx2)
                Set RgFunctionEx2 = RangeOfValue(UserForm1.cbFunctionEx2.Value, intFunctionEx2, RgFunctionEx)
                UpdateComboBox UserForm1.cbFunctionEx3, RgFunctionEx2, intFunctionEx3, RgFunctionEx3
            Else
                InvalidCB UserForm1.cbFunctionEx2
                GoTo LAST
            End If
            
            'update Function Ex3
            If VinCombo(ReadValue(intISFunctionEx3), UserForm1.cbFunctionEx3) Then
                UserForm1.cbFunctionEx3.Value = ReadValue(intISFunctionEx3)
                Set RgFunctionEx3 = RangeOfValue(UserForm1.cbFunctionEx3.Value, intFunctionEx3, RgFunctionEx2)
            Else
                InvalidCB UserForm1.cbFunctionEx3
                GoTo LAST
            End If
