...
Sub Autoexec()
    ...
    If Not TOOLKIT_LOADED Then
        ...
        sPreview = strCoreTemplatesPath
        Set IniOP = New INIHelper
        
        'Image folder path
        strImagePath = Options.DefaultFilePath(wdPicturesPath)
        
        'Help file path
        strHelpFile = BASE_PATH & "\MVCOT_Instructions.docx"
...
Private Sub CreateNewUserIni()
    ...
    If Not FileExists(strUserIni) Then
        ...
        With FSOFile
            .WriteLine ("; User INI Configuration file for MSD.")
