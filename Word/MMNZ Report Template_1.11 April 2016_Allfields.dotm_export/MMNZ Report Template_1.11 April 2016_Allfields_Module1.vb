...
'    ActiveDocument.Unprotect Password:="w1n1"
    ...
    With Selection.PageSetup
        ...
        .FooterDistance = CentimetersToPoints(0.65)
...
Sub InsertA3Page(control As IRibbonControl)
    ...
    Dim blSamePagesetup As Boolean
    blSamePagesetup = False
    Application.ScreenUpdating = False
    
    If Selection.PageSetup.PaperSize = wdPaperA4 And Selection.PageSetup.Orientation = wdOrientLandscape And control.Tag = "A4L" Then
        blSamePagesetup = True
    End If
    If Selection.PageSetup.PaperSize = wdPaperA4 And Selection.PageSetup.Orientation = wdOrientPortrait And control.Tag = "A4P" Then
        blSamePagesetup = True
    End If
    If Selection.PageSetup.PaperSize = wdPaperA3 And Selection.PageSetup.Orientation = wdOrientPortrait And control.Tag = "A3P" Then
        blSamePagesetup = True
    End If
    If Selection.PageSetup.PaperSize = wdPaperA3 And Selection.PageSetup.Orientation = wdOrientLandscape And control.Tag = "A3L" Then
        blSamePagesetup = True
    End If
    ...
    On Error Resume Next
    With Selection
        If InStr(control.Tag, "AM") > 0 Then
    ...
    If InStr(control.Tag, "L") > 0 Then 'Landscape page
        If InStr(control.Tag, "4") > 0 Then 'A4 size
            dPageWidth = 29.7
            dPageHeight = 21
        Else                               'A3 size
            dPageWidth = 42
        ...
        End If
    Else                                'Portrait page
        If InStr(control.Tag, "4") > 0 Or InStr(control.Tag, "AM") > 0 Then 'A4 size
            dPageWidth = 21
            dPageHeight = 29.7
        Else                                'A3 size
            dPageWidth = 29.7
    ...
    With Selection.PageSetup
        .Orientation = IIf(InStr(control.Tag, "L") > 0, wdOrientLandscape, wdOrientPortrait)
        .TopMargin = CentimetersToPoints(2.54)
        .BottomMargin = CentimetersToPoints(2.54)
        .LeftMargin = CentimetersToPoints(2.54)
        .RightMargin = CentimetersToPoints(2.54)
        ...
        .HeaderDistance = CentimetersToPoints(1.25)
        .FooterDistance = CentimetersToPoints(0.65)
        .PageWidth = CentimetersToPoints(dPageWidth)
        .PageHeight = CentimetersToPoints(dPageHeight)
    End With
