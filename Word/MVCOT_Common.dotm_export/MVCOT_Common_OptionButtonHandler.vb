...
Private Sub cb_Click()
    Debug.Print Caption
    frmTemplatePicker.imgPreview.Picture = LoadPicture(strImagePath & "\" & Caption & IMG_EXTENSION, frmTemplatePicker.imgPreview.Width, frmTemplatePicker.imgPreview.Height)
End Sub
